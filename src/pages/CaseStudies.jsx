        ...
        {caseStudies.map((item) => (
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              {/* OVERLAY */}
              <div className="absolute inset-0 bg-orange-500/70 opacity-0 group-hover:opacity-100 transition flex items-center justify-center">
            ...
            {/* CONTENT */}
            <div className="p-5">
              <h3 className="text-lg font-semibold text-black group-hover:text-orange-500 transition">
                {item.title}
              </h3>
            </div>
          </div>
