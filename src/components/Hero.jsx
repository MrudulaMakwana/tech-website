...
const Hero = () => {
  ...
  return (
    <section className="w-full min-h-screen mt-10 pt-20 relative overflow-hidden bg-gray-100 text-black dark:bg-gray-900 dark:text-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6 relative">

        {/* PREV BUTTON */}
        <div
          ref={prevRef}
          className="absolute left-3 md:left-0 top-1/2 -translate-y-1/2 z-50 cursor-pointer"
        >
          <span className="text-orange-500 text-4xl md:text-7xl font-bold hover:text-black dark:hover:text-white transition">
            &#8249;
          </span>
        </div>
        ...
        <div
          ref={nextRef}
          className="absolute right-3 md:right-0 top-1/2 -translate-y-1/2 z-50 cursor-pointer"
        >
          <span className="text-orange-500 text-4xl md:text-7xl font-bold hover:text-black dark:hover:text-white transition">
            &#8250;
          </span>
