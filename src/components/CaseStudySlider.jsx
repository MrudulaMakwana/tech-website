...
const CaseStudySlider = () => {
  ...
  return (
    <div className="py-10 md:py-20 bg-gray-100 relative">
      <div className="max-w-6xl mx-auto px-4 relative">

        {/* 🔥 NAVIGATION BUTTONS (RESPONSIVE) */}
        <div className="custom-prev absolute left-2 md:left-0 top-1/2 -translate-y-1/2 z-10 cursor-pointer">
          <span className="text-orange-500 text-3xl md:text-6xl font-bold hover:text-black transition">
            &#8249;
          </span>
        </div>
          ...
          <SwiperSlide>
            <div className="flex flex-col md:flex-row items-center justify-between min-h-[60vh] md:min-h-[70vh] px-4 md:px-16 py-10 gap-8">
              ...
              <div className="w-full md:w-1/2 space-y-4 text-center md:text-left">
                ...
                <button
                  className="flex items-center justify-center md:justify-start gap-2 bg-orange-500 text-white px-5 md:px-6 py-2 rounded-lg hover:bg-black transition mx-auto md:mx-0"
              ...
              <div className="w-full md:w-1/2 flex justify-center">
                <img
                  src={case1}
                  alt="case1"
                  className="w-[90%] md:w-[80%] max-w-sm md:max-w-none"
                />
              </div>
            </div>
          </SwiperSlide>
